'''
python eval_feature_binary_svm.py --label P > output/eval_feature_binary_svm-P-output.txt
python eval_feature_binary_svm.py --label V > output/eval_feature_binary_svm-V-output.txt

python eval_feature_binary_svm.py --label P > output/eval_feature_binary_svm-P-output-32C.txt
python eval_feature_binary_svm.py --label V > output/eval_feature_binary_svm-V-output-32C.txt
'''
import argparse
import os
import pandas as pd
...
for idx in range(len(features)):
    ...
    # Train
    # 
    model = SVC(max_iter=50000,gamma='scale',probability=True)
